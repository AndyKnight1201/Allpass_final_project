...
<head>
    ...
    <link href="{{asset('/css/backend/feedback_index.css')}}" rel="stylesheet" type="text/css">
</head>
...
<body>
    ...
    <main>
        <div class='main_hander d-flex justify-content-between'>
            <span class="title d-flex align-items-center">留言管理</span>
            ...
            <div class="list-detail">
                <div id="section1" class="container-xxl mt-3 mb-5">
                    <table class="table table-striped table-bordered dt-responsive wrap" style="width:100%" id="information">
                        <thead>
                            <tr>
                                <th class="text-center">名稱(稱謂)</th>
                                <th class="text-center">日期(時段)</th>
                                <th class="text-center">留言</th>
                                <th class="text-center">電話、信箱</th>
                        ...
                        <tbody>
                            ...
                            <tr class="item{{$item->id}}">
                                ...
                                <td class="pb-0 pe-1" style="max-width: 200px;">
                                    <div class="scrollbar" style="max-height: 100px ;overflow: auto;">
                                        {{ $item->suggestion }}
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $index }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <h5 class="modal-title" id="exampleModalLabel">編輯輪播順序</h5>
                                    ...
                                    <form action="/backend/feedback/delete/{{$item->id}}" method="post" hidden id="deleteForm{{$item->id}}">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
    ...
    <script>
        ...
        updateCarouselBtn.forEach((e, index) => {
            ...
            e.onclick = ()=>{
                ...
                let feedbackId = data[index].dataset.feedback_id;

                fetch(`/backend/feedback/${feedbackId}`, {
                    method: 'POST',
                    body: formData,
                })
