...
<head>
    ...
    <link href="{{asset('/css/backend/news_create.css')}}" rel="stylesheet" type="text/css">
</head>
...
<body>
    ...
    <main>
        <div class='main_hander d-flex justify-content-between'>
            <span class="title d-flex align-items-center">新增消息</span>
        ...
        <div class="w-75 main_content mx-auto">
            <div class="pt-5 w-100 historyBox">
                ...
                <div class="w-100 py-5 historyContent d-flex justify-content-center">
                    <div class="px-5 w-75 addMealBox">
                        <form action="/new/store" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label for="">標題:</label>
                                <input class="w-100 form-control" type="text" name="title" required>
                            </div>
